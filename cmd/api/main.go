...
func main() {
	...
	fmt.Println("database url @@@@@@@@@@@@@@", cfg.DatabaseURI)
	database_uri := `postgres://postgres:postgres@localhost:5432/goshop?sslmode=disable`

	db, err := dbs.NewDatabase(database_uri)
	if err != nil {
